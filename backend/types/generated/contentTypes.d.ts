...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    highlights: Schema.Attribute.Component<'tour-spec.highlight-item', true>;
    itinerary: Schema.Attribute.Component<'tour-spec.itinerary-day', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    whatsIncluded: Schema.Attribute.Component<'tour-spec.inclusion-item', true>;
    whatsNotIncluded: Schema.Attribute.Component<
      'tour-spec.exclusion-item',
      true
    >;
  };
}
