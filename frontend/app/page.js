...
export default function HomePage() {
  ...
  const travelAgencySchema = {
    ...
    '@id': 'https://moroccovibetours.com/#organization',
    'name': 'Morocco Vibe',
    'alternateName': 'Morocco Vibe Travel & Tours',
    'url': 'https://moroccovibetours.com',
    'logo': 'https://moroccovibetours.com/assets/logo-full.png',
    'image': 'https://moroccovibetours.com/assets/desert-luxury-1.png',
    'telephone': '+212634332000',
    'email': 'contact@moroccovibetours.com',
    'priceRange': '$$$',
    'address': {
      '@type': 'PostalAddress',
